...
<form method="post" action="customer.php" onformchange="mark_change_flag();">
<input type="hidden" name="session_index" value="$session_index">
<input type="hidden" name="status" value="update">
<input type="hidden" name="customer_code" value="$customer_code">
<div class="customer_details_main_page">
<div class="customer_details_buttons">
	<input type="button" nname="bn5" class="vertical_button" value="New Task" onclick="fadein_assignments('$session_index','$customer_code');">
	<input type="button" nname="bn5" class="vertical_button" value="Last Tasks" onclick="fadein_last_tasks('$session_index','$customer_code');">
	<input type="button" nname="bn5" class="vertical_button" value="New Meeting">
	<input type="button" nname="bn5" class="vertical_button" value="New Task">
	<input type="button" nname="bn5" class="vertical_button" value="New Task">
	<input type="button" nname="bn5" class="vertical_button" value="New Task">
	<input type="button" nname="bn5" class="vertical_button" value="New Task">
</div>
<div class="customer_details_main">
	...
	<div class="horizontal_buttons" style="width: {$buttons_div_length}px;">
		...
		<input type="button" name="bn2" value="Main Page" class="horizontal_button" onclick="goto_main_page('$session_index');">
...
ENDLINE;
		...
		{
			print <<<ENDLINE
			<input type="button" name="bn4" value="Contacts" class="horizontal_button" onclick="fadein_contacts('$session_index','$customer_code');">
ENDLINE;
		}
		print <<<ENDLINE
	</div>
