...
<div style="width: 1050px;"><div class="main_new_leads">New Leads</div></div><p>&nbsp;</p>
<div class="main_new_leads_details">
	<table class="main_new_leads_table">
	<tr style="text-align: center;"><td>First Name</td><td>Last Name</td><td>Media Source</td><td>Media Source 2</td><td>Scheduled On</td><td>Scheduled For</td></td><td>Summary</td><td>People In Party</td>
	<td>&nbsp;</td></tr>
...
order by bizua_unix desc limit 5"); while ($details = $sth->fetch())
{
	...
	<td>$details[people_in_party]</td>
	<td style="text-align: center;" nowrap>
	<input type="button" name="bn3" value="GO" class="customer_search_button" onclick="go_to_lead('$details[code]');" shelly="$details[code]">
	<input type="button" name="bn3A" value="SHOW" class="customer_search_button" onclick="show_lead_details('$details[code]');" shelly="$details[code]">
	</td>
	</tr>
ENDLINE;
}
...
<div style="width: 1050px;"><div class="main_new_leads">To Do List</div></div><p>&nbsp;</p>
<div class="main_new_leads_details">
	<table class="main_new_leads_table">
	<tr style="text-align: center;"><td>First Name</td><td>Last Name</td><td>Media Source</td><td>Media Source 2</td><td>Scheduled On</td><td>Scheduled For</td>
	<td>Summary</td><td>People In Party</td><!--<td>Result</td>--><td>&nbsp;</td></tr>
...
order by bizua_unix desc limit 5"); while ($details = $sth->fetch())
{
	...
	<td nowrap><input type="button" name="bn3" value="GO" class="customer_search_button" onclick="go_to_lead('$details[code]');" shelly="$details[code]">
	<input type="button" name="bn3A" value="SHOW" class="customer_search_button" onclick="show_lead_details('$details[code]');" shelly="$details[code]"></td>
	</tr>
ENDLINE;
}
