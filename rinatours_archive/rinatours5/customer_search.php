...
<div class="customer_search_fields">
	...
	<td>Creation Date From</td><td>Creation Date To</td><td colspan="2">&nbsp;</td></tr>
	<tr><td><input type="date" class="customer_search_text" name="creation_date_from"></td>
	<td><input type="date" class="customer_search_text" name="creation_date_to"></td>
	<td colspan="2">&nbsp;</td></tr>
	</tr></table></p>
