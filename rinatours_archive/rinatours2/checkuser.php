...
<h3 style="color: #314A07; font-family: arial; font-size: 16px; display: block; width: 400px; height: 30px; border-radius: 5px; background-color: #EDEDBF; line-height: 28px;">Wrong Username/Password</h3>

<table>
	<tr><td>שם משתמש</td><td><input type="text" name="username" class="text"></td></tr>
	<tr><td>סיסמה</td><td><input type="password" name="password" class="text"></td></tr>
