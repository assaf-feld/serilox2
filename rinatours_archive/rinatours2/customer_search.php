...
<div class="customer_search_fields">
	...
	<tr><td>by Name</td><td>By Email</td><td>By Phone Number</td><td>By City</td></tr>
	<tr><td><input type="text" class="customer_search_text" name="name"></td>
...
if ($session[status] == "update")
{
	...
	<tr><td>First Name</td><td>Last Name</td><td>Email</td><td>Phone Number</td><td>Phone 2</td><td>City</td><td>Password Exp. Date</td><td>&nbsp;</td></tr>
...
ENDLINE;
	...
	{
		print "<tr><td>$details[customer_name]</td><td>$details[customer_last_name]</td><td>$details[email_1]</td><td>$details[phone_1]</td><td>$details[phone_2]</td><td>$details[city]</td><td>$details[passport_exp_date]</td>
		<td style='text-align: center;'><input type='button' class='customer_search_button' value='Show' onclick=\"window.location='customer_details.php?session_index=$session[session_index]&customer_code=$details[code]&ic=$ic';\"></td></tr>";
	}
