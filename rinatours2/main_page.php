...
$sth = $dbh->query("select * from assignments where as_type = \"assignment\" and bizua_unix >= \"$our_time\" and (bapoal_date = \"0000-00-00\" or bapoal_date is NULL) order by bizua_unix desc limit 80");
