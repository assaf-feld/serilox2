...
$dbh = new PDO("mysql:host=localhost;dbname=rinatours1","root","");
...
if ($user_check[code])
{
	...
	$dbh->exec("insert into session values(NULL, '$user_check[code]', '$session_index', current_date, current_time, '$our_time', NULL, NULL, NULL, 'yes', '$our_time', NULL, NULL, '$_SERVER[REMOTE_ADDR]')");
	$dbh = NULL;
	$ic = rand();
	print <<<ENDLINE
	<htm>
