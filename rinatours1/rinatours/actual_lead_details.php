...
<div align="center">
<iframe src="update_lead.php?session_index=$session[session_index]" style="border: 0; width: 0; height: 0;" name="update_lead_iframe"></iframe>
<h1 style="margin-top: 30px;">Lead Details</h1>
...
<td><input type="text" name="people_in_party" value="$our_lead[people_in_party]"></td>
<td>
...
<p><iframe src="customer_details_from_main.php?session_index=$session[session_index]&customer_code=$our_lead[customer_code]&ic=$ic" style="width: 100%; height: 500px; border: 0;"></iframe></p>
</body>
</html>
