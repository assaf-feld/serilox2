...
$(document).ready(function()
{
	...
	$("#id_new_leads").click(function()
	{
		// $("#div_new_leads").animate({height: '500px'}, 400);
		// $("#div_to_do_list").animate({height: '20px'}, 400);
		$("#div_new_leads").animate({height: '500px'}, 400);
		$("#div_to_do_list").animate({height: '0'}, 400);
		$("#div_future").animate({height: '0'}, 400);
	});
	$("#id_to_do_list").click(function()
	{
		$("#div_new_leads").animate({height: '0'}, 400);
		$("#div_future").animate({height: '0'}, 400);
		$("#div_to_do_list").animate({height: '500px'}, 400);
	});
	$("#id_future").click(function()
	{
		$("#div_new_leads").animate({height: '0'}, 400);
		$("#div_future").animate({height: '500px'}, 400);
		$("#div_to_do_list").animate({height: '0'}, 400);
	});
});
...
<div style="width: 1250px;"><div class="main_new_leads" id="id_new_leads" style="cursor: pointer;">New Leads</div></div><p>&nbsp;</p>
<div class="main_new_leads_details" id="div_new_leads">
...
<div style="width: 1250px;"><div class="main_new_leads" id="id_to_do_list" style="cursor: pointer;">To Do List</div></div><p>&nbsp;</p>
<div class="main_new_leads_details" id="div_to_do_list">
	<table class="main_new_leads_table">
...
<div style="width: 1250px;"><div class="main_new_leads" id="id_future" style="cursor: pointer;">Future Assignments</div></div><p>&nbsp;</p>
<div class="main_new_leads_details" id="div_future">
	<table class="main_new_leads_table">
	<tr style="text-align: center;"><td>Scheduled On</td><td>Customer Number</td><td>First Name</td><td>Last Name</td><td>Phone/Email</td><td>Media Source</td><td>Media Source 2</td><td>Scheduled For</td>
	<td>Summary</td><td>User Handeling</td><!--<td>Result</td>--><td>&nbsp;</td></tr>
...
$sth = $dbh->query("select * from assignments where as_type = \"assignment\" and (bapoal_date = \"0000-00-00\" or bapoal_date is NULL) order by bizua_unix desc limit 80");
