...
$(document).ready(function()
{
	...
	$("#expand_button").click(function()
	{
		...
		$("#table_leads_monitor_table").fadeIn(300);
		$("#id_leads_monitor_iframe").animate({height: '500px'}, 400);
	});
	$("#button_go").click(function()
	{
		$("#div_leads_monitor_fields").animate({height: '5px', padding: '10px'}, 400);
		$("#table_leads_monitor_table").fadeOut(300);
		$("#id_leads_monitor_iframe").animate({height: '750px'}, 400);
	});
});
</script>
</head>
...
<input type="hidden" name="status" value="update">
	...
	<div class="leads_monitor_fields" id="div_leads_monitor_fields"><table class="leads_monitor_table" id="table_leads_monitor_table">
...
ENDLINE;
	...
	<p><iframe src="leads_monitor_update.php?session_index=$session[session_index]&ic=$ic" class="leads_monitor_iframe" id="id_leads_monitor_iframe" name="leads_monitor_update_iframe"></iframe></p>
</body></html>
ENDLINE;
$dbh = NULL;
