...
{
	$("#confirm_update_div_1a").hide();
	$("#error_message_div_1a").hide();
	$("#passport_exp_div").hide();
	$("#customer_details_new_lead_1a").hide();
	$("#customer_details_confirm_div_1a").hide();
	$("#new_lead_button_x").click(function()
	{
		...
		$("#customer_details_new_lead_1a").fadeIn(300);
	});
});
...
function check_not_saved(our_page)
{
	...
	if(not_saved == true)
	{
		$("#customer_details_confirm_div_1a").fadeIn(300);
	}
	else
	{
		open_page();
...
{
	$("#customer_details_confirm_div_1a").fadeOut(300);
}
...
<body>
<div class="customer_details_new_lead_parent" style="overflow: hidden;"><div class="customer_details_new_lead" id="customer_details_new_lead_1a" style="overflow: hidden;">
...
<div class="confirm_update_div_parent"><div class="confirm_update_div" id="confirm_update_div_1a">Details Saved</div></div>
<div class="confirm_update_div_parent"><div class="error_message_div" id="error_message_div_1a"></div></div>
<div class="confirm_update_div_parent"><div class="passport_exp_div" id="passport_exp_div">Passport Expired</div></div>
<div class="confirm_div_parent"><div class="confirm_div" id="customer_details_confirm_div_1a">Data not saved. Continue? <input type="button" name="bn5" value="Continue" style="left: 50px;" onclick="open_page();"> 
...
<form method="post" action="update_customer_from_main.php" target="update_customer_iframe">
...
<iframe src="update_customer.php?session_index=$session[session_index]" width="0" height="0" border="0" name="update_customer_iframe"></iframe></div></body></html>;
ENDLINE;
$dbh = NULL;
